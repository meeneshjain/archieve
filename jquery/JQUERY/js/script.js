...
$(document).ready(function(){
	...
	blankrow += '<td><a href="javascript:;" class="'+savebutton+'" data="Save"><img src="'+saveImage+'"></a></td></tr>';
	...
	$(document).on("click","."+editbutton,function(){
		...
		if(id && editing == 0 && tdediting == 0){
			...
			html += '<td><a href="javascript:;" id="'+id+'" class="'+updatebutton+'" data="UPDATE"><img src="'+updateImage+'"></a> <a href="javascript:;" id="'+id+'" class="'+cancelbutton+'" data="CANCLE"><img src="'+cancelImage+'"></a></td>';
